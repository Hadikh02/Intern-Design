...
const NewRoom = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        hasProjector: false,
        capacity: 1,
        userId: null // This will be set from currentUser.id
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            try {
                ...
                throw new Error(responseText || 'Room creation failed');
            }
            ...
            if (!response.ok) {
                if (data.errors) {
                    ...
                    Object.keys(data.errors).forEach(key => {
                        formattedErrors[key] = data.errors[key].join(' ');
                    });
            ...
            await Swal.fire({
                ...
                text: `Room ${formData.roomNumber} has been created.`,
            ...
            <div className={`dashboard-main-content ${isOpen ? 'sidebar-open' : ''}`}>
                <div className="content-container">
                    <div className="dashboard-header">
                        <h2 className="dashboard-title">Create New Room</h2>
                        <p className="dashboard-subtitle">Fill in the details to add a new meeting room</p>
                    </div>

                    <form onSubmit={handleSubmit} className="form-container">
                        <h3 className="form-title">Room Registration</h3>
